...
const initialState: WalletStateModel = {
    ...
    selectedAccount:
        sw ? sw.accountList().length > 0 ? localAddr || sw.accountList()[0] : "" : undefined,
};
...
export const { setSessionWallet, setAccounts, setConnectedStatus, setSelectedAccount } = walletSlice.actions;
